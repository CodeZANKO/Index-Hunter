...
BARE_NAME_MAP = {
    ...
    # CLOUD / IAAS CONFIG FILES
    "appsettings.json": "CONFIG",
    "appsettings.development.json": "CONFIG",
    "local.settings.json": "CONFIG",
    "parameters.json": "CONFIG",
    "credentials.json": "CONFIG",
    "google-services.json": "PASSWORD",
    "service-account.json": "PASSWORD",
    "secrets.json": "PASSWORD",
    "terraform.tfvars": "PASSWORD",
    ...
    ".oci": "PASSWORD",
    "config.json": "CONFIG",
    "credentials.yml": "PASSWORD",
    "credentials.yaml": "PASSWORD",
    "credentials.tf": "PASSWORD",
    "web.config": "PASSWORD",
    "firebase.json": "PASSWORD",
    "firebase-config.json": "PASSWORD",
    "vault.json": "PASSWORD",
    "kubeconfig": "PASSWORD",
    "kubeconfig.yaml": "PASSWORD",
    "kubeconfig.yml": "PASSWORD",
    "clouds.yaml": "CONFIG",
    "clouds.yml": "CONFIG",
    "openstackrc": "PASSWORD",
    "ComputeEngine": "PASSWORD",
    "gcloud": "CONFIG",
    "boto": "PASSWORD",
    "boto3": "PASSWORD",
    ".aws": "PASSWORD",
    "credentials.csv": "PASSWORD",
    "root.key": "PASSWORD",
    "master.key": "PASSWORD",
    "production.env": "PASSWORD",
    "staging.env": "PASSWORD",
    "dev.env": "PASSWORD",
}
